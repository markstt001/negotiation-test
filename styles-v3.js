...
var styles = {
    ...
    ARCD: {
        ...
        celebrity: '你像诸葛亮——不需要太多言语，数据在手，战略在心。别人还在争论，你已经算出了三种结局。运筹帷幄之中，决胜千里之外，说的就是你这种人。',
        valuation: '稳健级（团队标配）'
    },
    ARCP: {
        animal: '🐘',
        ...
        celebrity: '你像《教父》里的汤姆·黑根——家族的法律顾问，用智慧维护关系，用忠诚赢得信任。你不站队，但人人都想和你一队。',
    ...
    ARBD: {
        ...
        celebrity: '你像福尔摩斯——别人看到表面，你看到细节；别人看到机会，你看到风险。细节决定成败，而你总能提前发现那些致命的细节。',
        valuation: 'R 级（稀有人才）'
    },
    ARBP: {
        animal: '🐜',
        ...
        celebrity: '你像乔布斯——把复杂变简单，把产品做到极致。你不追求完美，你追求的是让每个环节都顺畅无阻。流程在你手里，就是艺术。',
    },
    ...
    ATCD: {
        ...
        celebrity: '你像《大空头》里的迈克尔·布里——当所有人都在狂欢，你看到了泡沫；当所有人都在恐惧，你看到了机会。用数据洞察市场，在别人恐惧时获利。',
    ...
    ATCP: {
        ...
        celebrity: '你像《穿 Prada 的女魔头》里的米兰达——话不多，但每句都是决定。别人还在犹豫，你已经拍板；别人还在讨论，你已经拿到结果。决断力，就是你的超能力。',
        valuation: 'SR 级（史诗人才）'
    },
    ATBD: {
        animal: '🐬',
        ...
        level: '专家级：超越 90% 的同行，已是行业专家',
        celebrity: '你像《生活大爆炸》里的谢尔顿——逻辑是你的第一语言。别人说"我觉得"，你说"根据逻辑"。别人觉得你较真，但最后发现，还是你对。',
    },
    ATBP: {
        animal: '🐆',
        name: '效率优化师',
        ...
        level: '专家级：超越 90% 的同行，已是行业专家',
        celebrity: '你像埃隆·马斯克——一个人干五个人的活，还干得比别人好。你不追求忙碌，你追求的是单位时间的价值。效率，就是你的信仰。',
    },
    ...
    IRCD: {
        ...
        celebrity: '你像《心灵捕手》里的威尔·亨廷——用直觉理解世界，用天赋验证判断。别人说"不可能"，你说"让我算算"。然后你算出来，还真可能。',
        tags: '#直觉玩家 #数据验证 #人间清醒'
    },
    IRCP: {
        animal: '🐱',
        ...
        celebrity: '你像《当幸福来敲门》里的克里斯·加德纳——在绝境中看到机会，用坚持抓住机会。你不等运气，你创造运气。',
        valuation: 'SR 级（史诗人才）'
    },
    IRBD: {
        animal: '🐝',
        ...
        celebrity: '你像《人民的名义》里的侯亮平——用关系网推动事情，用直觉判断方向。别人办不成的事，你打个电话就成了。人脉，就是你的超能力。',
        valuation: 'A 轮级（高潜力人才）'
    },
    IRBP: {
        animal: '🐰',
        ...
        level: '专家级：超越 90% 的同行，已是行业专家',
        celebrity: '你像甘地——用温和化解冲突，用坚持赢得尊重。你不站队，但人人都听你的。平衡，就是你的力量。',
    },
    ...
    ITCD: {
        ...
        celebrity: '你像 007 詹姆斯·邦德——到任何环境都能生存，接任何任务都能完成。别人适应环境需要时间，你适应环境只需要一秒。',
    ...
    ITCP: {
        ...
        celebrity: '你像《了不起的盖茨比》里的盖茨比——用派对联结资源，用真诚感知需求。你不缺朋友，你缺的是时间——因为想认识你的人太多了。',
        tags: '#社交牛人 #资源链接 #人脉王'
    },
    ITBD: {
        animal: '🐢',
        ...
        celebrity: '你像《长安十二时辰》里的张小敬——平时不显山露水，关键时刻力挽狂澜。别人说你想太多，但最后发现，只有你想到了。',
    ...
    ITBP: {
        ...
        celebrity: '你像马云——看到未来就去做，做着做着就成了。别人说你在做梦，但最后发现，是你把梦变成了现实。',
        tags: '#行动派 #愿景落地 #领航者'
    }
};
